...
public class Tabuleiro {
	...
	public Tabuleiro(){
		...
		TABULEIRO[0][0].setPeca(new Torre(2, branca, 0, 0, TorreBranca1));
		...
		TABULEIRO[0][1].setPeca(new Cavalo(4, branca, 0, 1, CavaloBranco1));
		pecasDoJogo.add(TABULEIRO[0][1].getPeca());
		
		GameImage BispoBranco1 = new GameImage("BispoBanco1.png");
		TABULEIRO[0][2].setPeca(new Bispo(3, branca, 0, 2, BispoBranco1));
...
//		Rei reiBranco = new Rei(-1, branca, 0, 3,"  |K(B)| ");
		...
		TABULEIRO[0][3].setPeca(new Rei(-1, branca, 0, 3, ReiBranco));
		...
		TABULEIRO[1][0].setPeca(new Peao(1, branca, 1, 0, peaoBranco1));
		...
		TABULEIRO[1][1].setPeca(new Peao(1, branca, 1, 1, peaoBranco2));
		...
		TABULEIRO[1][2].setPeca(new Peao(1, branca, 1, 2, peaoBranco3));
		...
		TABULEIRO[1][3].setPeca(new Peao(1, branca, 1, 3, peaoBranco4));
		...
		TABULEIRO[1][4].setPeca(new Peao(1, branca, 1, 4, peaoBranco5));
		...
		TABULEIRO[1][5].setPeca(new Peao(1, branca, 1, 5, peaoBranco6));
		...
		TABULEIRO[1][6].setPeca(new Peao(1, CorDaPeca.BRANCA, 1, 6, peaoBranco7));
		...
		TABULEIRO[1][7].setPeca(new Peao(1, branca, 1, 7, peaoBranco8));
		...
		TABULEIRO[7][0].setPeca(new Torre(2, preta, 7, 0, TorrePreta1));
...
//		Rei reiBranco = new Rei(-1, branca, 0, 3,"  |K(B)| ");
		...
		TABULEIRO[6][0].setPeca(new Peao(1, preta, 6, 0, peaoPreto1));
		...
		TABULEIRO[6][1].setPeca(new Peao(1, preta, 6, 1, peaoPreto2));
		...
		TABULEIRO[6][2].setPeca(new Peao(1, preta, 6, 2, peaoPreto3));
		...
		TABULEIRO[6][3].setPeca(new Peao(1, preta, 6, 3, peaoPreto4));
		...
		TABULEIRO[6][4].setPeca(new Peao(1, preta, 6, 4, peaoPreto5));
		...
		TABULEIRO[6][5].setPeca(new Peao(1, preta, 6, 5, peaoPreto6));
		...
		TABULEIRO[6][6].setPeca(new Peao(1, preta, 6, 6, peaoPreto7));
		...
		TABULEIRO[6][7].setPeca(new Peao(1, preta, 6, 7, peaoPreto8));
